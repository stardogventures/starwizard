...
public abstract class AccessTokenResponse {
    ...
    @ApiModelProperty(value = "access token value", example = "2YotnFZFEjr1zCsicMWsdv")
    public abstract String getAccessToken();

    @JsonProperty("token_type")
    @ApiModelProperty(value = "access token type", example = "bearer")
    public abstract String getTokenType();

    @JsonProperty("expires_in")
    @ApiModelProperty(value = "expiration time of token, in seconds", example = "86400")
    public abstract int getExpiresIn();

    @JsonProperty("refresh_token")
    @ApiModelProperty(value = "refresh token value", example = "tGzv3JOkF0XG5Qx2TlKWIA")
    public abstract Optional<String> getRefreshToken();

    @JsonProperty("scope")
    @ApiModelProperty(value = "scope of the access token", example = "admin")
